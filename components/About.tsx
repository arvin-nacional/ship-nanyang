      ...
      <div className="grid w-[1200px] max-w-full grid-cols-2 gap-10 px-2 pb-6 align-top max-md:mt-10 max-sm:grid-cols-1">
        <div className="flex flex-col items-start justify-center">
          ...
          <p className="paragraph-regular mt-5 ">
            We make global shopping effortless for customers in the Philippines
            by bringing products from China right to your doorstep. With our
            trusted and convenient logistics service, you can enjoy access to
            China’s vast marketplace and have peace of mind knowing your orders
            will be delivered securely to your home. Whether it’s hard-to-find
            items or unique products, we’re here to simplify the entire process,
            so you can focus on what matters—enjoying your purchases.
          </p>
