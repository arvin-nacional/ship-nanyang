...
const MessengerBtn = () => {
  return (
    <div className="fixed bottom-4 right-4 flex flex-col items-center gap-3">
      {/* WhatsApp */}
      <Link
        href="https://wa.me/85260911394"
        target="_blank"
        rel="noopener noreferrer"
        aria-label="Chat on WhatsApp"
      >
        <div className="h-[50px] w-[50px] rounded-full bg-[#25D366] flex items-center justify-center shadow-lg hover:scale-110 transition-transform">
          <svg
