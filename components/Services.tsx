...
export function Services() {
  return (
    <div className="flex items-center justify-center max-md:px-2 max-sm:py-5 bg-gray-100">
      <div className="flex flex-col items-start justify-center max-w-[1200px] pt-20 pb-20 max-md:px-4 max-sm:py-16">
      <p className="h1-bold text-dark-400 mb-5 pb-5 text-center w-full">Our Services</p>
